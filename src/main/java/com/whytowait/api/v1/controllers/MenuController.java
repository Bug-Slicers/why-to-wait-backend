...
public class MenuController {
    ...
    @PostMapping(path = "/create-item", consumes = {"multipart/form-data"})
    public MenuItem CreateMenuItem(@RequestPart("imageFile") MultipartFile imageFile, @RequestPart("menuItem") CreateMenuItemRequestDTO requestDTO) throws BadRequestException {
        //return menuService.CreateMenuItem(requestDTO, imageFile);
        return null;
    }
